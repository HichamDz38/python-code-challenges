...
def check(grid):
    ...
    for row in grid:
        ...
        for r in R:
            if r!=0 and R.count(r)>1:
                logging.debug('row conflict {}'.format(r))
                logging.debug(R)
                return False
    gridp = list(zip(*grid))
    ...
    for row in gridp:
        ...
        for r in R:
            if r!=0 and R.count(r)>1:
                logging.debug('column conflict {}'.format(r))
                logging.debug(R)
                return False
    groups = []
    for i in range(3):
    ...
    for g in groups:
        ...
        for r in R:
            if r!=0 and R.count(r)>1:
                logging.debug('inner grid coflict {}'.format(r))
                logging.debug(R)
                return False
    return True
